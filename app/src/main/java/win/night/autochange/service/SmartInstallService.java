package win.night.autochange.service;
...
public class SmartInstallService extends AccessibilityService
{
    ...
    {
        Toast.makeText(this, "智能安装onInterrupt", Toast.LENGTH_SHORT).show();
    ...
    protected void onServiceConnected()
    {
        ...
        Toast.makeText(this, "智能安装onServiceConnected", Toast.LENGTH_SHORT).show();
